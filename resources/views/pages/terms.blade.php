    ...
    <div class="container">
        <div class="row justify-content-center" id="main-header">
            <div class="col-md-8">
                ...
                <p>Last updated: February 20, 2020</p>
                ...
                <ul>
                    ...
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AliDevs.</li>
                ...
                <li><strong>Website</strong> refers to AliDevs, accessible from https://alidevs.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                </ul>
                ...
                <ul>
                    <li>By email: me@alidevs.com</li>
                    <li>By visiting this page on our website: https://alidevs.com/contact</li>
                </ul>
            </div>
        </div>
    </div>
